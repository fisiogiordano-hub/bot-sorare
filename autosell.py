...
BOT_VERSION = (
    "29.0-AUTOSELL-SOLANA-PREPARE-FIX"
)
...
def get_gallery():
    ...
    print(
        ...
        f"🔒 Carte in Cassaforte "
        f"escluse: {sealed_count}",
...
#
# Perciò NON inviamo più "type".
#
# Manteniamo invece sendAssetIds / receiveAssetIds /
# receiveAmount / clientMutationId.
# ============================================================
