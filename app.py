...
def headers():
    ...
    result = {
        ...
        "Authorization": token,
        "User-Agent": "Sorare-Python-Bot/4.0",
    }
...
def controlla_squadra(card):
    ...
    for championship in dict.fromkeys(
        found
    ):
        print(
            f"         🟢 {championship}",
