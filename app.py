...
def card_price(card):
    ...
    # --------------------------------------------------------
    # DEBUG SOLO SE IL PREZZO NON VIENE TROVATO
    # --------------------------------------------------------
...
def valid_card(card):
    ...
    if price is None:
        print(
            ...
            "(nessun prezzo EUR trovato "
            "nella risposta Sorare)",
            flush=True,
        )
        return False
