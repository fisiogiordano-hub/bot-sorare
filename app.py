...
def card_price(card):
    ...
    for source_name in (
        ...
        try:
            ...
            ).get("receiverSide", {}).get("amounts", {}).get("eurCents")
...
def counter_offer(offer, cards):
    ...
    # IMPORTANTE:
    # NON inseriamo "type".
    # Il tuo schema Sorare ha risposto che type
    # non esiste in prepareOfferInput.
    # --------------------------------------------------------
...
def worker():
    ...
    print(
        "🔧 PREPARE: DIRECT_OFFER senza campo type",
        flush=True,
    )
    print(
