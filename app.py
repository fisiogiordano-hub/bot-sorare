...
if data.get("errors"):
    print(
        "❌ prepareOffer GRAPHQL GLOBAL ERROR:",
        flush=True,
    )
...
if not result:
    print(
        "❌ prepareOffer ha restituito NULL",
        flush=True,
    )
    return False
...
if not data:
    print(
        "❌ Nessuna risposta da createDirectOffer",
        flush=True,
    )
    return False
...
if data.get("errors"):
    print(
        "❌ createDirectOffer GRAPHQL GLOBAL ERROR:",
        flush=True,
    )
...
if not result:
    print(
        "❌ createDirectOffer ha restituito NULL",
        flush=True,
    )
    return False
...
print(
    "🔧 PREPARE: EUR settlementCurrencies",
    flush=True,
)
